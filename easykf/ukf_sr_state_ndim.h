...
// Question :
// S'assurer du fonctionnement des dtrsv avec les Trans, NoTrans , Upper, Lower
// Faut il utiliser l'ensemble augmenté des sigma points pour calculer Syk ?
// Il reste le problème qu'en le testant, il rejoint bien la trajectoire au début, puis s'en écarte
...
namespace ukf
{
    ...
    /**
      * @short Square root UKF for state estimation, additive noise case
